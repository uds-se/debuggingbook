...
* You can __read chapters in your browser__.  Check out the list of chapters in the menu above, or start right away with the [introduction to testing](https://www.debuggingbook.org/html/Intro_Testing.html) or the [introduction to fuzzing](https://www.debuggingbook.org/html/Fuzzer.html).  All code is available for download.
...
This book is written by _Andreas Zeller_, a long-standing expert in automated debugging, software analysis and software testing.  We are happy to share our expertise and making it accessible to the public.
...
3. **Run the notebook locally** in a Docker container. For more information, see [How to use the book with Docker](https://github.com/uds-se/debuggingbook/blob/master/deploy/README.md).  
...
We have compiled a number of [tours through the book](https://www.debuggingbook.org/html/Tours.html) for various audiences.  Our [Sitemap](https://www.debuggingbook.org/html/00_Table_of_Contents.html) lists the dependencies between the individual chapters.
